...
json.first_name input_employee.first_name.upcase
if input_employee.last_name && input_employee.last_name.length <= 7
  json.last_name input_employee.last_name
else
  json.last_name "#{input_employee.last_name} (wow that's a long last name)"
end
json.full_name input_employee.full_name
